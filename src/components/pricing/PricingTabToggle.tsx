...
export function PricingTabToggle({
  ...
  return (
    <div className="mx-auto max-w-3xl text-center pt-8 pb-4">
      ...
      {/* Tab Switch Buttons */}
      <div className="mx-auto mt-6 flex w-fit items-center rounded-2xl border border-surface-border/80 bg-surface p-1.5 shadow-xs">
        <button
          type="button"
          onClick={() => onTabChange("customers")}
          className={`flex items-center gap-2 rounded-xl px-5 py-2.5 text-xs font-bold transition-all duration-200 cursor-pointer sm:text-sm ${
            activeTab === "customers"
