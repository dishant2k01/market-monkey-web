        ...
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-6">
            ...
            <div className="mt-7 flex flex-nowrap items-center gap-3 sm:gap-4">
              <a
                href="#get-the-app"
                className="inline-flex shrink-0 items-center justify-center gap-2.5 whitespace-nowrap rounded-full bg-brand-primary px-6 py-3 text-xs font-bold text-white shadow-xs transition-all hover:bg-brand-primary-hover hover:shadow-sm sm:text-sm"
              >
