            ...
            <AnimateIn variant="fade-up" delay={250} duration={600}>
              <div className="mt-8 flex flex-nowrap items-center gap-3 sm:gap-4">
                <Button
                  ...
                  className="shrink-0 whitespace-nowrap font-semibold transition-transform duration-200 hover:-translate-y-0.5"
                >
                  Explore Markets
                </Button>
                ...
                <button
                  type="button"
                  className="inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-full border border-surface-border bg-surface px-5 py-3 text-sm font-semibold text-ink shadow-xs transition-all duration-200 hover:bg-surface-subtle hover:border-brand-soft-border hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-brand-primary"
                  onClick={() => {
