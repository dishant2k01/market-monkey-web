...
import {
  ...
  type MonkeyTestimonial,
} from "@/components/become/MonkeyTestimonialCard";
import { Button } from "@/components/ui/Button";
import { ArrowLeftIcon, ArrowRightIcon } from "@/components/ui/icons";

type MonkeyTestimonialsSliderProps = {
  testimonials: MonkeyTestimonial[];
};
...
export function MonkeyTestimonialsSlider({
  testimonials,
}: MonkeyTestimonialsSliderProps) {
